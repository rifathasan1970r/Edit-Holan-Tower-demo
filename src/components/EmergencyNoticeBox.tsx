...
const EmergencyNoticeBox: React.FC<EmergencyNoticeBoxProps> = ({ onClick }) => (
  ...
  >
    <div className="flex items-start gap-3">
      ...
      <div>
        <h4 className="font-bold text-amber-900 dark:text-amber-100 text-sm mb-0.5">জরুরী নোটিশ</h4>
        <p className="text-[10px] text-amber-800 dark:text-amber-200 leading-tight line-clamp-1">বিস্তারিত দেখুন...</p>
      </div>
    </div>
    <ChevronRight className="text-amber-500 shrink-0" size={18} />
  </motion.button>
);
